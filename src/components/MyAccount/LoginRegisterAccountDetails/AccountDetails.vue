<template>
  <v-col class="mt-1 mb-10" cols="10" offset="1" align-center justify-center>
    <v-card>
      ...
      <v-card-actions>
        <v-row>
          <v-col cols="10" offset="1" v-if="!canEdit">
            <v-btn block right color="#061122" @click="edit" dark
              >Edit User Details</v-btn
            >
          </v-col>
          <v-col cols="10" offset="1" v-if="canEdit">
            <v-btn block right color="#061122" @click="update" dark
              >Update</v-btn
            >
          </v-col>
          <v-col cols="10" offset="1" v-if="canEdit" class="mb-2">
